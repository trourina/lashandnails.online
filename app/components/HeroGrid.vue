...
onMounted(() => {
  intervalId = setInterval(() => {
    activeService.value = activeService.value === 4 ? 1 : activeService.value + 1;
  }, 4000);
});
onUnmounted(() => {
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="animated-grid">
          <div
            ...
            :key="item.id"
            :class="['grid-item', `grid-item-${item.id}`, { featured: activeService === item.id }]"
          >
            <!-- Placeholder gradient -->
            <div class="absolute inset-0 bg-gradient-to-br from-[#E8D5C4] to-[#D4C4B4]">
              <!-- Shimmer effect -->
              <div
