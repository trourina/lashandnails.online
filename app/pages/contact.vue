    ...
    <section class="container mx-auto px-4 py-12">
      <div class="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        ...
        <div class="bg-gray-50 rounded-3xl p-8 text-center">
          <div
            class="w-16 h-16 bg-[#6B5B52] rounded-full flex items-center justify-center mx-auto mb-4"
          >
          ...
          <h3 class="font-display font-semibold text-gray-900 mb-2">
            {{ contactCardTitle("phone") }}
          </h3>
          <a
            :href="`tel:${settings.phone}`"
            class="text-gray-600 hover:text-[#6B5B52] transition-colors"
          >
            {{ settings.phone }}
          </a>
        </div>
        ...
        <div class="bg-gray-50 rounded-3xl p-8 text-center">
          ...
          <p class="text-gray-600">
            {{ settings.address.street }}<br />{{ settings.address.city }}
          </p>
        </div>
