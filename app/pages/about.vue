    ...
    <section class="bg-gray-50 py-16">
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div class="w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110" :class="[
              index === 0 ? 'bg-[#6B5B52]/10' : '',
              index === 1 ? 'bg-[#FFC107]/15' : '',
              index === 2 ? 'bg-[#E8D5C4]/40' : '',
            ]">
              <!-- Certificate icon -->
              <svg v-if="index === 0" class="w-8 h-8 text-[#6B5B52]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
              </svg>
              <!-- Clock icon -->
              <svg v-else-if="index === 1" class="w-8 h-8 text-[#8B7565]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
              <!-- Diamond/sparkle icon -->
              <svg v-else class="w-8 h-8 text-[#6B5B52]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
      ...
      <div class="container mx-auto px-4">
        <div class="relative max-w-4xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <DecorCircle v-if="index % 2 === 0" color="brown" size="sm" bottom="-0.5rem" right="-0.5rem" />
