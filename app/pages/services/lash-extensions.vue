...
const { data: sanityService, encodeDataAttribute } = await useFetchService("lash-extensions");
const { data: pricingCategories } = await useFetchPricingForCategory("lash-extensions");
...
const techniques = computed(
  () =>
    sanityService.value?.techniques?.map((t) => ({
      name: s(t.name),
